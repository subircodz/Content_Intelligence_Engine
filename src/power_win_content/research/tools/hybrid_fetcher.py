...
class HybridFetcher:
    """
    Hybrid fetcher that tries HTTP first, falls back to browser for JavaScript-heavy pages.
    """
    ...
    def fetch(self, url: str) -> Optional[str]:
        """
        Fetch a URL, trying HTTP first then falling back to browser if needed.
        ...
        logger.info("HTTP fetch insufficient for %s, falling back to browser", url)
